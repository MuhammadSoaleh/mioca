...
<!-- Mirrored from template.hasthemes.com/mioca/mioca/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 06:40:13 GMT -->
...
<body>
                                    ...
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            ...
                                            <ul class="d-flex align-items-center p-0 border-0">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="assets/images/banner/menu-banner-1.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
    ...
    <div class="section ">
        <div class="hero-slider swiper-container slider-nav-style-1 slider-dot-style-1">
            ...
            <div class="swiper-wrapper">
                <!-- Single slider item -->
                <div class="hero-slide-item slider-height swiper-slide d-flex bg-color1" data-bg-image="assets/images/slider-image/slider-bg-1.jpg">
                ...
                <div class="col-12">
                    ...
                    <div class="tab-slider swiper-container slider-nav-style-1 small-nav">
                        <ul class="product-tab-nav nav swiper-wrapper ">
                            <li class="nav-item swiper-slide"><a class="nav-link active" data-bs-toggle="tab" href="#tab-jewelry"> <img src="assets/images/icons/jewelry-icon.png" alt=""><span>Jewelry</span></a>
                            </li>

                            <li class="nav-item swiper-slide"><a class="nav-link" data-bs-toggle="tab" href="#tab-pottery"> <img src="assets/images/icons/pottery-icon.png" alt=""><span>Pottery</span></a>
                            </li>
                            <li class="nav-item swiper-slide"><a class="nav-link" data-bs-toggle="tab" href="#tab-fabric"> <img src="assets/images/icons/fabric-icon.png" alt=""><span>Fabric</span></a>
                            </li>
                            <li class="nav-item swiper-slide"><a class="nav-link" data-bs-toggle="tab" href="#tab-paintings"> <img src="assets/images/icons/paintings-icon.png" alt=""><span>Paintings</span></a>
                            </li>
                            <li class="nav-item swiper-slide"><a class="nav-link" data-bs-toggle="tab" href="#tab-sculptures"> <img src="assets/images/icons/sculptures-icon.png" alt=""><span>Sculptures</span></a>
                            </li>
                            <li class="nav-item swiper-slide"><a class="nav-link" data-bs-toggle="tab" href="#tab-wooden"> <img src="assets/images/icons/wooden-icon.png" alt=""><span>Wooden</span></a>
                            </li>
                            <li class="nav-item swiper-slide"><a class="nav-link" data-bs-toggle="tab" href="#tab-pottery"> <img src="assets/images/icons/pottery-icon.png" alt=""><span>Pottery</span></a>
                            </li>
                        </ul>
    ...
    <div class="deal-area pb-100px pt-100px">
        <div class="container ">
            <div class="row">
                <div class="col-12">
                    <div class="deal-inner deal-bg position-relative ptb-80px" data-bg-image="assets/images/deal-img/deal-bg.jpg">
                ...
                <div class="col-12">
                    ...
                    <div class="tab-slider nav-center">
                        <ul class="product-tab-nav nav justify-content-center align-items-center">
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-fabric-2"><span>Fabric</span></a>
                            </li>
                            <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#tab-wooden-2"><span>Wooden</span></a>
                            </li>

                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-pottery-2"><span>Pottery</span></a>
                            </li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-jewelry-2"><span>Jewelry</span></a>
                            </li>
                        </ul>
                    </div>
                    <!-- Tab End -->
                ...
                <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px">
                    <div class="single-blog">
                        ...
                        <div class="blog-text">
                            ...
                            <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.html">How to Explain Handmade Product to Your Boss</a></h5>
                                ...
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            ...
                                            <li class="li"><a class="single-link" href="contact.php">Contact Us</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<!-- Mirrored from template.hasthemes.com/mioca/mioca/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 06:40:52 GMT -->
